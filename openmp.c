...
void minorGraph(int nnz, int *c, int*I, int*J, int*resultI, int *resultJ, int threads);
...
int main(int argc, char *argv[]) {
    ...
    minorGraph(nz,c,I,J,resultI,resultJ, threads);
...
void minorGraph(int nz,int *c, int*I,int*J,int*resultI,int *resultJ, int threads){
